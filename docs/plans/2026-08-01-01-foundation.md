...
- [x] **Step 1: Удалить старый код, оставив измерения**
...
- [x] **Step 3: Разделённые зависимости**
...
- [x] **Step 4: `Makefile` с целями ровно из `docs/README.md`**
...
- [x] **Step 5: Пустые пакеты и тест на дерево**
...
- [x] **Step 8: `.env.example` и `LICENSES.md`** (`docs/SETUP.md` §1, §2)
...
- [x] **Step 4: Запустить — должен пройти**
...
- [x] **Step 4: Запустить — должны пройти**
...
- [x] **Step 3: Реализация `validators/__init__.py`**
...
- [x] **Step 5: `validators/cli.py` — цель `make validate`**
...
- [x] **Step 2: Запустить — должен пройти на текущем коде**

Run: `python -m pytest tests/test_boundaries.py -v`
Expected: PASS, 5 тестов.

- [x] **Step 3: Убедиться, что тест действительно ловит нарушение**
...
- [x] **Step 3: Обновить корневой README.md**
